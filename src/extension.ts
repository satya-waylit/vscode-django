...
export async function activate(context: ExtensionContext): Promise<void> {
  ...
  context.subscriptions.push(
    languages.registerCompletionItemProvider(djangoPythonSnippets.selector, djangoPythonSnippets),
  );

  const djangoAdminSnippets = new DjangoAdminCompletionItemProvider(snippetProvider);
  context.subscriptions.push(
    languages.registerCompletionItemProvider(djangoAdminSnippets.selector, djangoAdminSnippets),
  );

  const djangoFormSnippets = new DjangoFormCompletionItemProvider(snippetProvider);
  context.subscriptions.push(
    languages.registerCompletionItemProvider(djangoFormSnippets.selector, djangoFormSnippets),
  );

  const djangoManagerSnippets = new DjangoManagerCompletionItemProvider(snippetProvider);
  context.subscriptions.push(
    languages.registerCompletionItemProvider(djangoManagerSnippets.selector, djangoManagerSnippets),
  );
  ...
  context.subscriptions.push(
    languages.registerCompletionItemProvider(djangoModelSnippets.selector, djangoModelSnippets),
  );

  const djangoViewSnippets = new DjangoViewCompletionItemProvider(snippetProvider);
  context.subscriptions.push(
    languages.registerCompletionItemProvider(djangoViewSnippets.selector, djangoViewSnippets),
  );
  ...
  context.subscriptions.push(
    languages.registerCompletionItemProvider(djangoUrlSnippets.selector, djangoUrlSnippets),
  );
